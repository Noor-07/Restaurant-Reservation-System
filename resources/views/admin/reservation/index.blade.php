                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                @if($reservation->status == true)
                                                    <button type="button" class="btn btn-success btn-sm"><span class="label label-danger">Confirmed</span></button>
                                                @else
                                                    <button type="button" class="btn btn-danger btn-sm"><span class="label label-danger">not Confirmed yet</span></button> 
                                                @endif
