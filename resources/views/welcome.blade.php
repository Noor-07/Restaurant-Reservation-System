...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
        ...
        <section id="great-place-to-enjoy" class="great-place-to-enjoy">
            <img class="frontend/img-responsive section-icon hidden-sm hidden-xs" src="{{asset('frontend/images/icons/beer_black.png')}}">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
        ...
        <section id="breakfast" class="breakfast">
            <img class="frontend/img-responsive section-icon hidden-sm hidden-xs" src="{{asset('frontend/images/icons/bread_black.png')}}">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
        ...
        <section id="bread" class="bread">
            <img class="frontend/img-responsive section-icon hidden-sm hidden-xs" src="{{asset('frontend/images/icons/bread_color.png')}}">
            <div class="container-fluid">
                <div class="row dis-table">
        ...
        <section id="featured-dish" class="featured-dish">
            <img class="frontend/img-responsive section-icon hidden-sm hidden-xs" src="{{asset('frontend/images/icons/food_black.png')}}">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
